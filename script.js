document.addEventListener('DOMContentLoaded', () => {
        ...
        sourceCards.forEach(card => {
            ...
            if (indexName.includes(cleanedQuery)) {
                ...
                clonedCard.addEventListener('click', () => {
                    if (indexName.includes("free fire")) initializeProductSelection("FREE FIRE");
                    if (indexName.includes("pubg")) initializeProductSelection("PUBG");
                    if (indexName.includes("call of duty")) initializeProductSelection("CALL OF DUTY");
                    if (indexName.includes("fifa")) initializeProductSelection("FIFA MOBILE");
                    if (indexName.includes("pes")) initializeProductSelection("PES MOBILE");
                    if (indexName.includes("blood strike")) initializeProductSelection("BLOOD STRIKE");
                });
    ...
    document.querySelector('#home-content-section .ff-card').addEventListener('click', () => initializeProductSelection("FREE FIRE"));
    document.querySelector('#home-content-section .pubg-card').addEventListener('click', () => initializeProductSelection("PUBG"));
    document.querySelector('#home-content-section .cod-card').addEventListener('click', () => initializeProductSelection("CALL OF DUTY"));
    document.querySelector('#home-content-section .fifa-card').addEventListener('click', () => initializeProductSelection("FIFA MOBILE"));
    document.querySelector('#home-content-section .pes-card').addEventListener('click', () => initializeProductSelection("PES MOBILE"));
    document.querySelector('#home-content-section .bs-card').addEventListener('click', () => initializeProductSelection("BLOOD STRIKE"));
